...
BOARD_HAS_VIBRATOR_IMPLEMENTATION := ../../device/rikomagic/mk802/vibrator.c
...
#EGL stuff
BOARD_EGL_CFG := device/rikomagic/mk802/egl.cfg
USE_OPENGL_RENDERER := true
BOARD_USE_SKIA_LCDTEXT := true
ENABLE_WEBGL := true

#Recovery Stuff
#BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/rikomagic/mk802/recovery_keys.c
BOARD_UMS_LUNFILE := "/sys/class/android_usb/android0/f_mass_storage/lun/file"
BOARD_UMS_2ND_LUNFILE := "/sys/class/android_usb/android0/f_mass_storage/lun1/file"
#TARGET_RECOVERY_INITRC := device/rikomagic/mk802/recovery_init.rc
...
TARGET_HARDWARE_INCLUDE := $(TOP)/device/rikomagic/mk802/libraries/include
TARGET_PROVIDES_INIT_RC := true
TARGET_BOOTANIMATION_PRELOAD := true
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/rikomagic/mk802/releasetools/mk802_ota_from_target_files
